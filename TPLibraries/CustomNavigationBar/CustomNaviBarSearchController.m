...
- (void)initUI
{
    ...
    [_btnType setBackgroundImage:[UIImage imageNamed:@""] forState:UIControlStateNormal];
    ...
    [_imgLogo setFrame:CGRectMake((ScreenWidth-84)/2, (NaviBarHeight-24)/2, 56, 24)];
    _imgLogo.hidden = YES;
...
- (void)showDailyNavigation
{
    [_viewCtrlParent naviBarAddCoverView:_viewNaviBar];
    _imgLogo.hidden = YES;
    _searchBar.hidden = YES;
    [_btnType setBackgroundImage:[UIImage imageNamed:@"NaviBtn_Search"] forState:UIControlStateNormal];
    [_btnZXing setBackgroundImage:[UIImage imageNamed:@"NaviBtn_Search"] forState:UIControlStateNormal];
    _bIsFixation = NO;
    _bIsCoverTitleView = NO;
    _bIsSearch = YES;
...
- (void)showSearchNavigation
{
    ...
    _btnType.hidden = NO;
    [_btnType setBackgroundImage:[UIImage imageNamed:@"NaviBtn_Back"] forState:UIControlStateNormal];
