...
#define NaviBarOrignY                       IsiOS7Later?20.0f:0.0f
...
#define turn5(w)     ([UIScreen mainScreen].bounds.size.width/320.0f*w)
#define turn6(w)     ([UIScreen mainScreen].bounds.size.width/375.0f*w)
#define turn6P(w)    ([UIScreen mainScreen].bounds.size.width/414.0f*w)

#define PROPORTION                  (ScreenWidth/320.0f)
#define PROPORTION414               (ScreenWidth/414.0f)
...
#define RGB_FONT                                RGB(102.0f,102.0f,102.0f)
