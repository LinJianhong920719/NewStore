...
//            _activityIndicatorView = activity;
            ...
            JQIndicatorView *indicator = [[JQIndicatorView alloc] initWithType:2 tintColor:[UIColor colorWithRed:254/255.0f green:215/255.0f blue:20/255.0f alpha:1]];
...
//            stateIndicator.image = [UIImage imageNamed:@"加载图片"];
//            [self addSubview:stateIndicator];
//            _stateIndicatorView = stateIndicator;
//            _stateIndicatorView.bounds = CGRectMake(0, 0, 22, 22);
...
- (void)setActivityHeight:(CGFloat)height {
    _activityIndicatorView.center = CGPointMake(bounds_width/2, height+SDKNavigationBarHeight-18);
}
...
- (void)setRefreshState:(SDRefreshViewState)refreshState
{
    ...
    switch (refreshState) {
        ...
        {
            DLog(@"contentInset.top:%f",self.scrollView.contentInset.top);
